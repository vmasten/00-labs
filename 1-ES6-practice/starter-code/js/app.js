...
function displayPics(){
  ...
  // Because rando was changed to let, its scope is now confined within the block of the while loop, so even though the log occurs within the function, it occurs too late to be successful
  console.log(viewed)
